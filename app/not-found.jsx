    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold tracking-tighter text-center mb-12">Powerful features for Your Career Growths</h2>
      ...
      <section className="w-full ">
        <div className="mx-auto py-24 bg-gradient-to-r from-white to-gray-100 rounded-lg border">
